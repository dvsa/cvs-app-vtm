import { VehicleTechRecordModel, StatusCodes, VehicleTypes, RetarderBrake, SpeedCategorySymbol, FitmentCode, FuelTypes, VehicleConfigurations, EuVehicleCategories, VehicleSizes, approvalType, MicrofilmDocumentType, BodyTypeDescription } from '../app/models/vehicle-tech-record.model';
