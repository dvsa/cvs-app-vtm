...
export function createInitialState(initialAdrDetails: any): any {
  return {
    ...
    selectReferenceNumber: initialAdrDetails.tank.tankStatement ? initialAdrDetails.tank.tankStatement.hasOwnProperty('statement') ?
    ...
    tc2IntermediateExpiryDate: {
      day: initialAdrDetails.tank.tankDetails.tc2Details.tc2IntermediateExpiryDate ?
        initialAdrDetails.tank.tankDetails.tc2Details.tc2IntermediateExpiryDate.split('-')[2] : '',
      month: initialAdrDetails.tank.tankDetails.tc2Details.tc2IntermediateExpiryDate ?
        initialAdrDetails.tank.tankDetails.tc2Details.tc2IntermediateExpiryDate.split('-')[1] : '',
      year: initialAdrDetails.tank.tankDetails.tc2Details.tc2IntermediateExpiryDate ?
        initialAdrDetails.tank.tankDetails.tc2Details.tc2IntermediateExpiryDate.split('-')[0] : ''
    },
    tc3Type: [],
    tc3PeriodicNumber: [],
    tc3PeriodicExpiryDate: [],
    memosApply: initialAdrDetails.memosApply ? initialAdrDetails.memosApply
      .includes('07/09 3mth leak ext') ? '07/09 3mth leak ext' : '' : '',
    ...
    certificateReq: initialAdrDetails.additionalNotes.guidanceNotes ? initialAdrDetails.additionalNotes.guidanceNotes
      .includes('New certificate requested') ? 'New certificate requested' : '' : '',
