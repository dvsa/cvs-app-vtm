...
describe('TechnicalRecordService', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [BatchTechnicalRecordService, provideMockStore({ initialState: initialAppState }), HttpService, TechnicalRecordService],
    });
  ...
  describe('validateForBatch', () => {
    ...
    describe('when both vin and trailer id are provided', () => {
      ...
      it('throws an error if more than 1 vehicle exists with those values', async () => {
        ...
        jest.spyOn(httpService, 'searchTechRecords').mockReturnValue(of([mockSearchResult, { ...mockSearchResult, systemNumber: 'foobar' }]));
