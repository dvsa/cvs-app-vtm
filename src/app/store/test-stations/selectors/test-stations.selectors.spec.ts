...
import {
  getTestStationFromProperty, testStation, testStations, testStationsLoadingState,
...
describe('Test Results Selectors', () => {
  ...
  describe('getTestStationsFromProperty', () => {
    it('return a test station with a matching testStationName', () => {
      ...
      expect(getTestStationFromProperty('testStationName', 'foo').projector(testStationsArray)).toEqual(testStationsArray[0]);
    });
    it('return a test station with a matching PNumber', () => {
      ...
      expect(getTestStationFromProperty('testStationPNumber', '356728').projector(testStationsArray)).toEqual(testStationsArray[1]);
    });
  });
});
