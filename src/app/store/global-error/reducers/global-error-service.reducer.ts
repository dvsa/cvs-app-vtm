...
export const globalErrorReducer = createReducer(
  ...
  on(
    ...
    TechnicalRecordServiceActions.postProvisionalTechRecord,
    TechnicalRecordServiceActions.putUpdateTechRecords,
  ...
  on(
    ...
    TechnicalRecordServiceActions.postProvisionalTechRecordFailure,
    TechnicalRecordServiceActions.putUpdateTechRecordsFailure,
