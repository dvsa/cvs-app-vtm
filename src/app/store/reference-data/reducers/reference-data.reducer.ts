...
export const referenceDataReducer = createReducer(
  ...
  on(fetchReferenceData, (state, action) => ({ ...state, [action.resourceType]: { ...state[action.resourceType] } })),
  ...
  on(fetchReferenceDataAudit, (state, action) => ({ ...state, [action.resourceType]: { ...state[action.resourceType] } })),
  ...
  on(fetchReferenceDataByKey, (state, action) => ({ ...state, [action.resourceType]: { ...state[action.resourceType] } })),
  ...
  on(fetchReferenceDataByKeySearchFailed, (state, action) => ({
    ...state,
    [action.resourceType]: {
      ...state[action.resourceType], searchReturn: null, loading: false, filter: null, term: null,
    },
  })),
  ...
  on(removeTyreSearch, (state) => ({
    ...
    [ReferenceDataResourceType.Tyres]: {
      ...state[ReferenceDataResourceType.Tyres], searchReturn: null, filter: null, term: null,
    },
  })),
  on(deleteReferenceDataItemSuccess, (state, action) => {
    ...
    currentState[`${resourceType}`] = resourceTypeAdapters[`${resourceType}`].removeOne(resourceKey, currentState[`${resourceType}`]);
  ...
  on(setReferenceDataLoading, (state, { loading, resourceType }) => ({
    ...state, [`${resourceType}`]: { ...state[`${resourceType}`], loading },
  })),
);
