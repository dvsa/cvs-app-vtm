...
export const spinnerReducer = createReducer(
  ...
  on(TechnicalRecordServiceActions.getByVINFailure, TestResultActions.fetchTestResultsBySystemIdFailed, TestResultActions.fetchTestResultsBySystemIdSuccess, TestResultActions.fetchTestResultsFailed, TestResultActions.fetchTestResultsSuccess, (state) => ({ ...state, showSpinner: false }))
);
