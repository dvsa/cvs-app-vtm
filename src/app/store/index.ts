...
import { initialSpinnerState, spinnerReducer, SpinnerState, STORE_FEATURE_SPINNER_KEY } from '@store/spinner/reducers/spinner.reducer';
import { defectsReducer, DefectsState, initialDefectsState, STORE_FEATURE_DEFECTS_KEY } from './defects';
