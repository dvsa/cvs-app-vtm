...
describe('TimeInputComponent', () => {
  ...
  it('should set properly the values for hour and time', fakeAsync(() => {
    fixture.componentInstance.testTimeControl = new FormControl('12:13');
    fixture.detectChanges();
    tick();

    expect(hourInput.nativeElement.value).toEqual('12');
    expect(minuteInput.nativeElement.value).toEqual('13');
  }));
