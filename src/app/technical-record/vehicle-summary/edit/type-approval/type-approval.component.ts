...
export class TypeApprovalComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.techRecordFg.addControl('approvalType', this.fb.control(this.activeRecord.approvalType));
    this.techRecordFg.addControl(
      'approvalTypeNumber',
      this.fb.control(this.activeRecord.approvalTypeNumber)
    );
    this.techRecordFg.addControl('ntaNumber', this.fb.control(this.activeRecord.ntaNumber));
    this.techRecordFg.addControl(
      'variantNumber',
      this.fb.control(this.activeRecord.variantNumber)
    );
    this.techRecordFg.addControl(
      'variantVersionNumber',
      this.fb.control(this.activeRecord.variantVersionNumber)
    );
  }
}
