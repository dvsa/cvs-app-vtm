...
const routes: Routes = [
  ...
  {
    path: TechRecordRoutes.TECH_RECORD_CORRECT_ERROR,
    component: TechRecordComponent,
    data: {
  ...
  {
    path: TechRecordRoutes.TECH_RECORD_NOTIFIABLE_ALTERATION_NEEDED,
    component: TechRecordComponent,
    data: {
      roles: Roles.TechRecordAmend,
      isEditing: true,
  ...
  {
    path: TechRecordRoutes.TECH_RECORD_GENERATE_LETTER,
  ...
  {
    path: TechRecordRoutes.TECH_RECORD_AMEND_REASON,
    component: TechRecordAmendReasonComponent,
    data: { roles: Roles.TechRecordAmend },
    canActivate: [MsalGuard, RoleGuard],
  },
  {
    path: TechRecordRoutes.TECH_RECORD_CHANGE_STATUS,
  ...
  {
    path: TechRecordRoutes.TECH_RECORD_UNARCHIVE_RECORD,
  ...
  {
    path: TechRecordRoutes.TECH_RECORD_CHANGE_VEHICLE_TYPE,
  ...
  {
    path: TechRecordRoutes.TECH_RECORD_CHANGE_VTA_VISIBILITY,
  ...
  {
    path: TechRecordRoutes.TECH_RECORD_CORRECT_ERROR_TYRE_SEARCH,
  ...
  {
    path: TechRecordRoutes.TECH_RECORD_CORRECT_ERROR_CHANGE_SUMMARY,
    component: TechRecordSummaryChangesComponent,
    data: { roles: Roles.TechRecordAmend },
    canActivate: [MsalGuard, RoleGuard],
  },
  {
    path: TechRecordRoutes.TECH_RECORD_NOTIFIABLE_ALTERATION_NEEDED_CHANGE_SUMMARY,
    component: TechRecordSummaryChangesComponent,
    data: { roles: Roles.TechRecordAmend },
    canActivate: [MsalGuard, RoleGuard],
  },
  {
    path: TechRecordRoutes.TECH_RECORD_NOTIFIABLE_ALTERATION_NEEDED_TYRE_SEARCH,
    component: TechRecordSearchTyresComponent,
    data: {
      title: 'Tyre search',
      roles: Roles.TechRecordAmend,
  ...
  {
    path: TechRecordRoutes.TECH_RECORD_TEST_RECORDS,
  ...
  {
    path: TechRecordRoutes.TECH_RECORD_ADR_CERTIFICATE,
