...
const routes: Routes = [
  {
    path: RootRoutes.ROOT_ROUTE_ROOT,
    ...
    children: [
      ...
      {
        path: RootRoutes.ROOT_ROUTE_SEARCH_TECHNICAL_RECORD,
      ...
      {
        path: RootRoutes.ROOT_ROUTE_CREATE_TECHNICAL_RECORD,
      ...
      {
        path: RootRoutes.ROOT_ROUTE_BATCH_CREATE_TECHNICAL_RECORD,
      ...
      {
        path: RootRoutes.ROOT_ROUTE_CURRENT_TEST_RESULT,
      ...
      {
        path: RootRoutes.ROOT_ROUTE_CURRENT_TECH_RECORD,
      ...
      {
        path: RootRoutes.ROOT_ROUTE_REFERENCE_DATA,
      ...
      {
        path: RootRoutes.ROOT_ROUTE_FEATURE_TOGGLE,
      ...
      {
        path: RootRoutes.ROOT_ROUTE_ERROR,
        pathMatch: 'full',
  ...
  {
    path: RootRoutes.ROOT_ROUTE_WILDCARD,
    pathMatch: 'full',
