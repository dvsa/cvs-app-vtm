...
export class UpdateTechRecordsService {
  ...
  public updateTechRecords(body: TechRecordPUT, systemNumber: string, oldStatusCode?: string, observe: any = 'body', reportProgress = false): Observable<any> {
    ...
    return this.httpClient.request<CompleteTechRecordPUT>(
      'put',
      `${this.basePath}/vehicles/${encodeURIComponent(String(systemNumber))}`,
      {
        body,
