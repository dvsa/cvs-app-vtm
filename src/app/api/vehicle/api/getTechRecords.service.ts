...
export class GetTechRecordsService {
  ...
  public getTechRecords(searchIdentifier: string, metadata?: boolean, status?: string, searchCriteria?: string, observe: any = 'body', reportProgress = false): Observable<any> {
    ...
    return this.httpClient.request<CompleteTechRecords>(
      'get',
      `${this.basePath}/vehicles/${encodeURIComponent(String(searchIdentifier))}/tech-records`,
      {
