...
import { MotorcycleSubmittedVehicleClass } from './motorcycleSubmittedVehicleClass';

export interface MotorcycleSubmitted { 
    testResultId: string;
    systemNumber: string;
    vin: string;
    ...
    testStatus: MotorcycleSubmitted.TestStatusEnum;
    vehicleType: string;
    noOfAxles: number;
    preparerId: string;
    preparerName: string;
    ...
    odometerReadingUnits: MotorcycleSubmitted.OdometerReadingUnitsEnum;
    reasonForCancellation: string;
    vehicleConfiguration: MotorcycleSubmitted.VehicleConfigurationEnum;
    testTypes: Array<CarSubmittedTestTypes>;
    vehicleClass: MotorcycleSubmittedVehicleClass;
}
export namespace MotorcycleSubmitted {
