...
export interface HgvSubmitted { 
    ...
    testStatus: HgvSubmitted.TestStatusEnum;
    ...
    odometerReadingUnits: HgvSubmitted.OdometerReadingUnitsEnum;
    countryOfRegistration: string;
    vehicleConfiguration: HgvSubmitted.VehicleConfigurationEnum;
    testTypes: Array<CarSubmittedTestTypes>;
    regnDate?: string;
}
export namespace HgvSubmitted {
