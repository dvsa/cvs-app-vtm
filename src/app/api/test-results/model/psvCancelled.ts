...
import { PsvCancelledTestTypes } from './psvCancelledTestTypes';

export interface PsvCancelled { 
    testResultId: string;
    systemNumber: string;
    vin: string;
    ...
    testStatus: PsvCancelled.TestStatusEnum;
    ...
    odometerReadingUnits: PsvCancelled.OdometerReadingUnitsEnum;
    vehicleConfiguration: PsvCancelled.VehicleConfigurationEnum;
    countryOfRegistration: string;
    vehicleSize: PsvCancelled.VehicleSizeEnum;
    testTypes: Array<PsvCancelledTestTypes>;
}
export namespace PsvCancelled {
    ...
    export type VehicleConfigurationEnum = 'rigid' | 'articulated';
