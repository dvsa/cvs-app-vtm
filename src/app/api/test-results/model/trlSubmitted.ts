...
import { TrlSubmittedTestTypes } from './trlSubmittedTestTypes';

export interface TrlSubmitted { 
    testResultId: string;
    systemNumber: string;
    vin: string;
    ...
    testStatus: TrlSubmitted.TestStatusEnum;
    ...
    vehicleConfiguration: TrlSubmitted.VehicleConfigurationEnum;
    trailerId: string;
    testTypes: Array<TrlSubmittedTestTypes>;
    firstUseDate?: string;
}
export namespace TrlSubmitted {
