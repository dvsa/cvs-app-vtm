 ...
 */
import { PsvSubmittedAdditionalInformation } from './psvSubmittedAdditionalInformation';

export interface PsvSubmittedDefects { 
    imNumber: number;
    ...
    prs: boolean;
    additionalInformation: PsvSubmittedAdditionalInformation;
}