...
export interface HgvCancelled { 
    ...
    testStatus: HgvCancelled.TestStatusEnum;
    ...
    odometerReadingUnits: HgvCancelled.OdometerReadingUnitsEnum;
    countryOfRegistration: string;
    vehicleConfiguration: HgvCancelled.VehicleConfigurationEnum;
    testTypes: Array<CarCancelledTestTypes>;
    regnDate?: string;
}
export namespace HgvCancelled {
