...
export interface CarCancelledVehicleClass { 
    code?: CarCancelledVehicleClass.CodeEnum;
    description?: CarCancelledVehicleClass.DescriptionEnum;
}
export namespace CarCancelledVehicleClass {
