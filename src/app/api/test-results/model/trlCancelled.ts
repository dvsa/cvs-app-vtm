...
import { TrlCancelledTestTypes } from './trlCancelledTestTypes';

export interface TrlCancelled { 
    testResultId: string;
    systemNumber: string;
    vin: string;
    ...
    testStatus: TrlCancelled.TestStatusEnum;
    ...
    vehicleConfiguration: TrlCancelled.VehicleConfigurationEnum;
    trailerId: string;
    testTypes: Array<TrlCancelledTestTypes>;
    firstUseDate?: string;
}
export namespace TrlCancelled {
