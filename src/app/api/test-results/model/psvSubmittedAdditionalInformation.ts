 ...
 */
import { PsvSubmittedAdditionalInformationLocation } from './psvSubmittedAdditionalInformationLocation';

export interface PsvSubmittedAdditionalInformation { 
    location: PsvSubmittedAdditionalInformationLocation;
    notes: string;
}