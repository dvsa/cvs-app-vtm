...
export interface CarSubmitted { 
    ...
    testStatus: CarSubmitted.TestStatusEnum;
    ...
    odometerReadingUnits: CarSubmitted.OdometerReadingUnitsEnum;
    reasonForCancellation: string;
    vehicleConfiguration: CarSubmitted.VehicleConfigurationEnum;
    testTypes: Array<CarSubmittedTestTypes>;
    vehicleSubclass: Array<string>;
}
export namespace CarSubmitted {
