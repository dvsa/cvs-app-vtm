...
export interface CarCancelled { 
    ...
    testStatus: CarCancelled.TestStatusEnum;
    ...
    odometerReadingUnits: CarCancelled.OdometerReadingUnitsEnum;
    reasonForCancellation: string;
    vehicleConfiguration: CarCancelled.VehicleConfigurationEnum;
    testTypes: Array<CarCancelledTestTypes>;
    vehicleSubclass: Array<string>;
}
export namespace CarCancelled {
