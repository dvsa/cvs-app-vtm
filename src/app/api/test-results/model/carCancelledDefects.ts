 ...
 */
import { CarCancelledAdditionalInformation } from './carCancelledAdditionalInformation';

export interface CarCancelledDefects { 
    imNumber: number;
    ...
    prs: boolean;
    additionalInformation?: CarCancelledAdditionalInformation;
}