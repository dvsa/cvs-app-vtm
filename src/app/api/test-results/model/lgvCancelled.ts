...
export interface LgvCancelled { 
    ...
    testStatus: LgvCancelled.TestStatusEnum;
    ...
    odometerReadingUnits: LgvCancelled.OdometerReadingUnitsEnum;
    reasonForCancellation: string;
    vehicleConfiguration: LgvCancelled.VehicleConfigurationEnum;
    testTypes: Array<CarCancelledTestTypes>;
    vehicleSubclass: Array<string>;
}
export namespace LgvCancelled {
