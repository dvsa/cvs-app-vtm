...
export interface CarCancelledModType { 
    code?: CarCancelledModType.CodeEnum;
    description?: CarCancelledModType.DescriptionEnum;
}
export namespace CarCancelledModType {
