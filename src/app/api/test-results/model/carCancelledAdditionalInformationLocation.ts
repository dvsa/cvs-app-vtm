...
export interface CarCancelledAdditionalInformationLocation { 
    vertical: CarCancelledAdditionalInformationLocation.VerticalEnum;
    horizontal: CarCancelledAdditionalInformationLocation.HorizontalEnum;
    lateral: CarCancelledAdditionalInformationLocation.LateralEnum;
    longitudinal: CarCancelledAdditionalInformationLocation.LongitudinalEnum;
    rowNumber: number;
    seatNumber: number;
    axleNumber: number;
}
export namespace CarCancelledAdditionalInformationLocation {
