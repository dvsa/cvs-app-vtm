...
import { CarSubmittedDefects } from './carSubmittedDefects';

export interface TrlSubmittedTestTypes { 
    name: string;
    testTypeName: string;
    testTypeId: string;
    ...
    testResult: TrlSubmittedTestTypes.TestResultEnum;
    testExpiryDate?: Date;
    defects: Array<CarSubmittedDefects>;
}
export namespace TrlSubmittedTestTypes {
