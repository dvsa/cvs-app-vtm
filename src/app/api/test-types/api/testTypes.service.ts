...
export class TestTypesService {
	...
	): Observable<HttpResponse<TestTypesTaxonomy>>;
	public getTestTypes(
		typeOfTest?: string,
		observe?: 'events',
		reportProgress?: boolean
	): Observable<HttpEvent<TestTypesTaxonomy>>;
	...
	public getTestTypesid(
		...
		observe?: 'response',
		reportProgress?: boolean
	): Observable<HttpResponse<TestTypeInfo>>;
	public getTestTypesid(
		id: string,
		fields: Array<string>,
		vehicleType: string,
		...
		observe?: 'events',
		reportProgress?: boolean
	): Observable<HttpEvent<TestTypeInfo>>;
	public getTestTypesid(
		id: string,
		fields: Array<string>,
		vehicleType: string,
