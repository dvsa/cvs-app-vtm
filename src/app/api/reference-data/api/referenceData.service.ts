...
import {
  HttpClient, HttpHeaders, HttpParams, HttpResponse, HttpEvent,
...
export class ReferenceDataService {
  ...
  public referenceLookupResourceTypeResourceKeyGet(
    ...
    return this.httpClient.request<ReferenceDataApiResponse>(
      'get',
      `${this.basePath}/reference/lookup/${encodeURIComponent(String(resourceType))}/${encodeURIComponent(String(resourceKey))}`,
      {
  ...
  public referenceLookupTyresSearchKeyParamGet(
    ...
    return this.httpClient.request<ReferenceDataApiResponse>(
      'get',
      `${this.basePath}/reference/lookup/tyres/${encodeURIComponent(String(searchKey))}/${encodeURIComponent(String(param))}`,
      {
        withCredentials: this.configuration.withCredentials,
        headers,
        // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
  ...
  public referenceResourceTypeGet(
    ...
    return this.httpClient.request<ReferenceDataApiResponse>(
      'get',
      `${this.basePath}/reference/${encodeURIComponent(String(resourceType))}`,
      {
  ...
  public referenceResourceTypeResourceKeyDelete(
    ...
    return this.httpClient.request<DeleteItem>(
      'delete',
  ...
  public referenceResourceTypeResourceKeyGet(
    ...
    return this.httpClient.request<ReferenceDataItemApiResponse>(
      'get',
      `${this.basePath}/reference/${encodeURIComponent(String(resourceType))}/${encodeURIComponent(String(resourceKey))}`,
      {
        withCredentials: this.configuration.withCredentials,
  ...
  public referenceResourceTypeResourceKeyPost(
    ...
    return this.httpClient.request<ReferenceDataItem>(
      'post',
      `${this.basePath}/reference/${encodeURIComponent(String(resourceType))}/${encodeURIComponent(String(resourceKey))}`,
      {
        // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
