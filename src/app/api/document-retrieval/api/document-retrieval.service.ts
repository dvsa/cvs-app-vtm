...
export class DocumentRetrievalService {
  ...
  public testCertificateGet(testNumber?: string, vin?: string, observe: any = 'body', reportProgress: boolean = false): Observable<any> {
    if (!vin) {
    ...
    if (testNumber) {
      queryParameters = queryParameters.set('testNumber', <any>testNumber);
    }
    if (vin) {
      queryParameters = queryParameters.set('vinNumber', <any>vin);
    }
    ...
    return this.httpClient.request<any>('get', `${this.basePath}/v1/document-retrieval`, {
