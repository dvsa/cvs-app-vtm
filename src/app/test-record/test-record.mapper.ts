...
export class TestRecordMapper {
  ...
  getCountryOfRegistrationCode(countryName: string) {
    const countryCode = Object.keys(COUNTRY_OF_REGISTRATION)[Object.values(COUNTRY_OF_REGISTRATION).indexOf(countryName)];
    return countryCode;
  }
  ...
  mapFormValues(testResultFormData, testResultObject: TestRecordTestType): TestResultModel {
    ...
    testResultMapped.countryOfRegistration = this.getCountryOfRegistrationCode(testResultFormData.countryOfRegistration);
    ...
    testResultMapped.preparerId = !!testResultFormData.preparer
      ...
      : '';
    testResultMapped.testStationName = '';
    testResultMapped.testStationPNumber = '';
