...
export const ErrorMessageMap: Record<string, Function> = {
  ...
  [ValidatorNames.RequiredIfEquals]: (err: { sibling: string; customErrorMessage: string }, label?: string) => err.customErrorMessage ?? `${label || DEFAULT_LABEL} is required with ${err.sibling}`,
