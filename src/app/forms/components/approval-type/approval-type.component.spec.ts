...
import {
  CustomFormControl, CustomFormGroup, FormNodeTypes, FormNodeWidth,
} from '@forms/services/dynamic-form.types';
import { provideMockStore } from '@ngrx/store/testing';
import { initialAppState } from '@store/index';
import { BaseControlComponent } from '../base-control/base-control.component';
import { FocusNextDirective } from '../date/focus-next.directive';
...
describe('ApprovalTypeComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [BaseControlComponent, ApprovalTypeInputComponent, FieldErrorMessageComponent, FocusNextDirective, HostComponent],
  ...
  describe('processApprovalTypeNumber', () => {
    it('should, for NTA, return either the first approvalNumber or null if this is falsy', () => {
      component.approvalTypeComponent.approvalType = ApprovalType.NTA;
      const result1 = component.approvalTypeComponent.processApprovalTypeNumber('number1', undefined, undefined, undefined);
      expect(result1).toBe('number1');

      const result2 = component.approvalTypeComponent.processApprovalTypeNumber(undefined, undefined, undefined, undefined);
    ...
    it('should, for ECTA, return either a full ECTA string if all 4 boxes are filled in, otherwise null', () => {
      ...
      const result5 = component.approvalTypeComponent.processApprovalTypeNumber(undefined, undefined, undefined, undefined);
