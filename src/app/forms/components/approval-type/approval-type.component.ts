...
const patterns: Record<string, RegExp> = {
  ...
  ECSSTA: /^e(.{2})\*KS(.{2})\/(.{5})\*(.{6})$/i, // 19
  'GB WVTA': /^(.{3})\*(.{4})\/(.{4,5})\*(.{7})$/i, // 22
  'UKNI WVTA': /^(.{1})11\*(.{4})\/(.{5})\*(.{6})$/i, // 21
  'EU WVTA Pre 23': /^e(.{2})\*(.{4})\/(.{4})\*(.{6})$/i, // 20
  'EU WVTA 23 on': /^e(.{2})\*(.{4})\/(.{4})\*(.{6})$/i, // 20
  QNIG: /^e(.{2})\*(.{4})\/(.{4})\*(.{6})$/i, // 20
  'Prov.GB WVTA': /^(.{3})\*(.{4})\/(.{5})\*(.{6})$/i, // 21
...
const patternsPartialMatch: Record<string, RegExp> = {
  ...
  'IVA - DVSA/NI': /^(.+)$/i,
  IVA: /^(.+)$/i,
  ECTA: /^e(.{0,2})\*(.{0,4})\/(.{0,5})\*(.{0,6})$/i,
  NSSTA: /^e(.{0,2})\*NKS\*(.{0,6})$/i,
  ECSSTA: /^e(.{0,2})\*KS(.{0,2})\/(.{0,5})\*(.{0,6})$/i,
  'GB WVTA': /^(.{0,3})\*(.{0,4})\/(.{0,5})\*(.{0,7})$/i,
  'UKNI WVTA': /^(.?)11\*(.{0,4})\/(.{0,5})\*(.{0,6})$/i,
  'EU WVTA Pre 23': /^e(.{0,2})\*(.{0,4})\/(.{0,4})\*(.{0,6})$/i,
  'EU WVTA 23 on': /^e(.{0,2})\*(.{0,4})\/(.{0,4})\*(.{0,6})$/i,
  QNIG: /^e(.{0,2})\*(.{0,4})\/(.{0,4})\*(.{0,6})$/i,
  'Prov.GB WVTA': /^(.{0,3})\*(.{0,4})\/(.{0,5})\*(.{0,6})$/i,
  'Small series NKSXX': /^(.?)11\*NKS(.{0,2})\/(.{0,4})\*(.{0,6})$/i, // 25
  'Small series NKS': /^(.?)11\*NKS\*(.{0,6})$/i, // 23
...
const patternsGenericPartialMatch: Record<string, RegExp> = {
  ...
  'IVA - DVSA/NI': /^(.+)$/i,
  IVA: /^(.+)$/i,
  ECTA: /^(.{0,2})(.{0,4})(.{0,5})(.{0,6})$/i,
  NSSTA: /^(.{0,2})(.{0,6})$/i,
  ECSSTA: /^(.{0,2})(.{0,2})(.{0,5})(.{0,6})$/i,
  'GB WVTA': /^(.{0,3})(.{0,4})(.{0,5})(.{0,7})$/i,
  'UKNI WVTA': /^(.?)(.{0,4})(.{0,5})(.{0,6})$/i,
