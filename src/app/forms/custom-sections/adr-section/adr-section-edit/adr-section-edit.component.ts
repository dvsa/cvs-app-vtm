...
export class AdrSectionEditComponent implements OnInit, OnDestroy {
  ...
  requiredWithExplosives(label: string): ValidatorFn {
    return (control) => {
      if (control.parent && !control.value && this.adrService.canDisplayCompatibilityGroupJSection(control.parent.value)) {
  ...
  requiredWithTankStatement(label: string): ValidatorFn {
    return (control) => {
      if (control.parent && !control.value && this.adrService.canDisplayTankStatementSelectSection(control.parent.value)) {
  ...
  requiredWithUNNumber(label: string): ValidatorFn {
    return (control) => {
      if (control.parent && !control.value && this.adrService.canDisplayTankStatementStatementSection(control.parent.value)) {
  ...
  requiredWithBatteryListApplicable(label: string): ValidatorFn {
    return (control) => {
      if (control.parent && !control.value && this.adrService.canDisplayBatteryListNumberSection(control.parent.value)) {
