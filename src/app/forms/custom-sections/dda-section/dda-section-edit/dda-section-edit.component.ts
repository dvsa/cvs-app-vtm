...
@Component({
  ...
  imports: [FormsModule, ReactiveFormsModule, GovukFormGroupRadioComponent, GovukFormGroupInputComponent, GovukFormGroupTextareaComponent],
})
  ...
  get psvControls() {
    return {
      ...
      techRecord_dda_seatbeltsFitted: this.fb.control<number | null>(null, [
        this.commonValidators.max(99, 'Seatbelts fitted must be less than or equal to 999'),
      ]),
