...
import { of } from 'rxjs';
import { LetterOfAuthorisationComponent } from '../letter-of-authorisation.component';
...
describe('LetterOfAuthorisationComponent', () => {
	let component: LetterOfAuthorisationComponent;
	let fixture: ComponentFixture<LetterOfAuthorisationComponent>;
	let store: MockStore;

	beforeEach(async () => {
		await TestBed.configureTestingModule({
			imports: [LetterOfAuthorisationComponent],
			providers: [
		...
		fixture = TestBed.createComponent(LetterOfAuthorisationComponent);
