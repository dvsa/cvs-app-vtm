...
describe('ManufacturerComponent', () => {
	...
	let componentRef: ComponentRef<ManufacturerComponent>;
	...
	beforeEach(async () => {
		...
		await TestBed.configureTestingModule({
			imports: [FormsModule, ReactiveFormsModule, ManufacturerComponent],
			providers: [
	...
	describe('shouldDisplayFormControl', () => {
		it('should return true if the form control exists on the form', () => {
			...
			const returnValue = component.shouldDisplayFormControl('techRecord_manufacturerDetails_name');
		...
		it('should return false if the form control does not exists on the form', () => {
			const formSpy = jest.spyOn(component.form, 'get');
			const returnValue = component.shouldDisplayFormControl('techRecord_manufacturerDetails_fakeName');
			expect(formSpy).toHaveBeenCalled();
