...
import { of } from 'rxjs';
import { AdrCertificatesComponent } from '../adr-certificates.component';

describe('AdrCertificates', () => {
	let component: AdrCertificatesComponent;
	let fixture: ComponentFixture<AdrCertificatesComponent>;
	...
	beforeEach(async () => {
		await TestBed.configureTestingModule({
			...
			imports: [AdrCertificatesComponent],
			schemas: [NO_ERRORS_SCHEMA],
		}).compileComponents();
	});
	beforeEach(async () => {
		fixture = TestBed.createComponent(AdrCertificatesComponent);
	...
	describe('generateADRCertificate', () => {
		it('should navigate when carriesDangerousGoodsSpy returns true', () => {
			...
			component.generateADRCertificate();
