...
import { combineLatest, filter, ReplaySubject, takeUntil } from 'rxjs';
import { TagType } from '@/src/app/components/tag/tag.component';
import { FitmentCode, ReasonForEditing, Tyre, VehicleTypes } from '@/src/app/models/vehicle-tech-record.model';
...
@Component({
  ...
  imports: [FormsModule, ReactiveFormsModule, GovukFormGroupInputComponent, GovukFormGroupSelectComponent, KeyValuePipe],
})
