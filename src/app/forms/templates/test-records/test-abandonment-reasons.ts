export const TestAbandonmentReasonsPsvData = [
  ...
  { value: 'The relevant test fee has not been paid', label: 'The relevant test fee has not been paid' },
  {
    ...
    label: 'There was no means of identifying the vehicle i.e. the vehicle chassis/serial number was missing or did not relate to the vehicle'
  },
  {
  ...
  },
  {
    ...
    label: 'The test could not be completed due to a failure of a part of the vehicle which made movement under its own power impossible'
  },
  {
