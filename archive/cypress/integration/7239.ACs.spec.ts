...
describe('VTM Detail - HGV+TRL Tech Record View', () => {
  ...
  context('AC4: HGV/TRL tech records are structured correctly', () => {
    ...
    it('the correct technical record is displayed', () => {
      cy.get('body > vtm-app > vtm-shell > div > div.main > vtm-technical-record > div > div > div > div:nth-child(2) > dl > div:nth-child(1) > dd:nth-child(2)').should('have.text', ' T13541234 ');
    });
  ...
  context('AC8: "-" is displayed, when an attribute has a value of "null" or space within DynamoDB', () => {
    ...
    it('I have been presented with a technical record', () => {
      cy.get('body > vtm-app > vtm-shell > div > div.main > vtm-technical-record > div > div > div > div:nth-child(2) > dl > div:nth-child(1) > dd:nth-child(2)').should('have.text', ' T12765432 ');
    });
