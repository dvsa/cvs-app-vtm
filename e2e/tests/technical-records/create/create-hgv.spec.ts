...
import { COMPLETE_HGV_1 } from '@/e2e/mocks/tech-records/hgv/complete-hgvs.mock';
import { SKELETON_HGV_1 } from '@/e2e/mocks/tech-records/hgv/skeleton-hgvs.mock';
import { TESTABLE_HGV_1 } from '@/e2e/mocks/tech-records/hgv/testable-hgvs.mock';
...
test.describe('Create HGV records', { tag: ['@tech-record', '@create-tech-record', '@hgv'] }, () => {
